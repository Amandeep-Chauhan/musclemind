        ...
        <AreaChart data={data} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
          <defs>
            <linearGradient id="revGrad" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%" stopColor="#ff3511" stopOpacity={0.25} />
              <stop offset="95%" stopColor="#ff3511" stopOpacity={0} />
            </linearGradient>
          ...
          />
          <Area type="monotone" dataKey="revenue" name="Revenue" stroke="#ff3511"
